...
## 1. Recording Principle (Proxy Server)
...
## 2. JMeter Recording Setup Sequence

### ① JMeter Setup (Setting up the Intermediary)
...
### ② Windows/Browser Setup (Sending Data to the Intermediary)
