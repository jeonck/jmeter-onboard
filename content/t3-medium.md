# t3.medium Instance Settings

## Recommended Load Test Values for t3.medium
...
### 1. Recommended Load Test Values for t3.medium

이 설정은 서버가 "적당히 바쁘면서도 분석 가능한 수준"을 유지하도록 설계되었습니다.

| Setting Item | Recommended Value | Meaning and Strategy |
|--------------|------------------|----------------------|
...
### 2. Scouter Metrics to Focus on with t3.medium
...
### 3. Practice Scenario: "Forced Bottleneck Creation"
...
### 4. Environment Setting Tips (t3.medium Specialized)
